...
int main(int argc, char **argv)
{
    ...
    SLAM.SaveKeyFrameTrajectoryTUM("/home/why/SLAM_WS/catkin_ORBSLAM2_ROS/src/orb_slam_2_ros/ros/result/KeyFrameTrajectory.txt");
...
RGBDNode::RGBDNode (ORB_SLAM2::System* pSLAM, ros::NodeHandle &node_handle, image_transport::ImageTransport &image_transport) : Node (pSLAM, node_handle, image_transport) {
  ...
  depth_subscriber_ = new message_filters::Subscriber<sensor_msgs::Image> (node_handle, "/camera/depth/image_raw", 1);
